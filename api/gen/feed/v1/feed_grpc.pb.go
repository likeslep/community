...
const (
	FeedService_GetFeed_FullMethodName = "/community.feed.v1.FeedService/GetFeed"
)
...
var FeedService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "community.feed.v1.FeedService",
	...
	Metadata: "api/proto/feed/v1/feed.proto",
}
