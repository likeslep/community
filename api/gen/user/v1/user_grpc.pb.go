...
const (
	UserService_Register_FullMethodName      = "/community.user.v1.UserService/Register"
	UserService_Login_FullMethodName         = "/community.user.v1.UserService/Login"
	UserService_GetProfile_FullMethodName    = "/community.user.v1.UserService/GetProfile"
	UserService_UpdateProfile_FullMethodName = "/community.user.v1.UserService/UpdateProfile"
	UserService_GetUser_FullMethodName       = "/community.user.v1.UserService/GetUser"
	UserService_ListUsers_FullMethodName     = "/community.user.v1.UserService/ListUsers"
	UserService_BanUser_FullMethodName       = "/community.user.v1.UserService/BanUser"
)
...
//
// UserService 提供用户注册、登录、资料与内部用户查询能力。
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "community.user.v1.UserService",
